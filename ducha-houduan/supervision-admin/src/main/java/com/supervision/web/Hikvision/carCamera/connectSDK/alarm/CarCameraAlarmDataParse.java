...
import com.supervision.web.Hikvision.carCamera.connectSDK.CommonMethod.CommonUtil;
...
//                  logger.info("车牌号：" + sLicense + ":车辆类型：" + VehicleType + ":布防点编号：" + MonitoringSiteID);
                ...
                GetCarInfo.logPlateInfo(plateInfo);

                // 车辆信息
                HCNetSDK.NET_DVR_VEHICLE_INFO vehicleInfo = result.struVehicleInfo;
                GetCarInfo.logVehicleInfo(vehicleInfo);
