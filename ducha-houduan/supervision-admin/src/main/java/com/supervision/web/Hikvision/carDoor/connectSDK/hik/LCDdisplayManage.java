...
public class LCDdisplayManage {
     ...
     */
    public void setCameractrlModeLCDdisplayInfo(HCNetSDK hCNetSDK, int lUserID) {
        String CameractrlModeLCDdisplayInfoUrl =
                "PUT /ISAPI/Parking/channels/1/LCD?format=json&powerOffSaveEnabled=true";
        /**
        ...
        String strInbuff =
                ConfigFileUtil.getReqBodyFromTemplate("/conf/ITC/CameractrlModeLCDdisplayInfo.json", parameter);
        logger.info("设置相机控制模式输入报文:" + strInbuff);
        String responseString = isapi.stdXMLConfig(hCNetSDK, lUserID, CameractrlModeLCDdisplayInfoUrl, strInbuff);
        logger.info("设置相机控制模式下LCD显示报返回报文：" + responseString);
        return;
    }
     ...
     * @param lUserID
     */
    public void getctrlModeLCDdisplayInfo(HCNetSDK hCNetSDK, int lUserID) {
        String getLCDdisplayInfoUrl = "GET /ISAPI/Parking/channels/1/LCD?format=json";
        String responseString = isapi.stdXMLConfig(hCNetSDK, lUserID, getLCDdisplayInfoUrl, "");
        logger.info("获取LCD参数返回报文:" + responseString);
    }
     ...
     * @param lUserID
     */
    public void setplatformctrlModeLCDdisplayInfo(HCNetSDK hCNetSDK, int lUserID) {
        String platformctrlModeLCDdisplayInfoUrl =
                "PUT /ISAPI/Parking/channels/1/LCD?format=json&powerOffSaveEnabled=true";
        /**
        ...
        String strInbuff =
                ConfigFileUtil.getReqBodyFromTemplate("/conf/ITC/CameractrlModeLCDdisplayInfo.json", parameter);
        logger.info("设置平台控制模式输入报文:" + strInbuff);
        String responseString = isapi.stdXMLConfig(hCNetSDK, lUserID, platformctrlModeLCDdisplayInfoUrl, strInbuff);
        logger.info("设置平台控制模式下LCD显示报返回报文：" + responseString);
        return;
    }
     ...
     * @param lUserID
     */
    public void setPicDisplayEnterNolicense(HCNetSDK hCNetSDK, int lUserID) {
        String setPicDisplayUrl = "POST /ISAPI/System/LCDScreen/displayInfo?format=json";
        /**
         *
         */
        Map<String, Object> parameter = new HashMap<>();
        parameter.put("QRCodeBase64",
                "iVBORw0KGgoAAAANSUhEUgAAAPoAAAD6CAIAAAAHjs1qAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAEKElEQVR4nO3dwW7bMBQAwb" +
        ...
        logger.info("设置图片显示输入报文:" + strInbuff);
        String responseString = isapi.stdXMLConfig(hCNetSDK, lUserID, setPicDisplayUrl, strInbuff);
        logger.info("设置图片显示返回报文：" + responseString);
        return;
    }
     ...
     * @param lUserID
     */
    public void setPicDisplayExitNoPay(HCNetSDK hCNetSDK, int lUserID) {
        String setPicDisplayUrl = "POST /ISAPI/System/LCDScreen/displayInfo?format=json";
        /**
         *
         */
     ...
     * @param lUserID
     */
    public void setEnterLicenseDisplay(HCNetSDK hCNetSDK, int lUserID) {
        ...
        logger.info("设置入场有车牌显示输入报文:" + strInbuff);
        String responseString = isapi.stdXMLConfig(hCNetSDK, lUserID, setEnterLicenseDisplayUrl, strInbuff);
        logger.info("设置入场有车牌返回报文：" + responseString);
        return;
    }
     ...
     * @param lUserID
     */
    public void setParkingLotDisPlay(HCNetSDK hCNetSDK, int lUserID) {
        String setEnterLicenseDisplayUrl = "POST /ISAPI/System/LCDScreen/displayInfo?format=json";
        /**
         *
         */
        ...
        logger.info("设置余位显示输入报文:" + strInbuff);
        String responseString = isapi.stdXMLConfig(hCNetSDK, lUserID, setEnterLicenseDisplayUrl, strInbuff);
        logger.info("设置余位返回报文：" + responseString);
        return;
    }
