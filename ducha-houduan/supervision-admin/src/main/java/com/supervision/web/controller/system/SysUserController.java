...
import com.supervision.system.service.ISysPostService;
...
public class SysUserController extends BaseController {
    ...
    public AjaxResult listByRole(@PathVariable Long roleId) {
        List<SysUser> list = userService.selectUserListByRoleId(roleId);
        return AjaxResult.success(list);
    }
    @GetMapping("/lists")
    public TableDataInfo lists(SysUser user) {
        startPage();
        List<SysUser> list = userService.selectUserLists(user);
        return getDataTable(list);
    }
    ...
    public AjaxResult add(@Validated @RequestBody SysUser user) {
        ...
        /**添加人员用户状态*/
        BdglPeople bdglPeople = peopleService.selectBdglPeopleById(Long.valueOf(user.getPeopleId()));
        bdglPeople.setUserId(user.getUserId());
