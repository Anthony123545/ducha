...
public class MutilCard {
    ...
    //设置群组参数
    public void setGroupCfg(HCNetSDK hCNetSDK, int lUserID) {
        ...
        struGroupCfg.write();
        if (!hCNetSDK.NET_DVR_SetDVRConfig(lUserID, 2113, 1, struGroupCfg.getPointer(), struGroupCfg.size())) {
            System.out.println(
                    "NET_DVR_SetDVRConfig NET_DVR_SET_GROUP_CFG失败，错误码：" + hCNetSDK.NET_DVR_GetLastError());
        } else {
     ...
     * @param lUserID
     */
    public void setMultiCardCfg(HCNetSDK hCNetSDK, int lUserID) {
        ...
        if (!hCNetSDK.NET_DVR_SetDVRConfig(lUserID, HCNetSDK.NET_DVR_SET_MULTI_CARD_CFG_V50, 1,
                struMultiCardCfg.getPointer(), struMultiCardCfg.size())) {
            System.out.println("NET_DVR_SetDVRConfig NET_DVR_SET_MULTI_CARD_CFG_V50 失败，错误码：" +
