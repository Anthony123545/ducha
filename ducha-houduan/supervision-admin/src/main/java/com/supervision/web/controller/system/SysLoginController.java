...
import com.supervision.common.core.domain.model.LoginBody;
import com.supervision.common.utils.SecurityUtils;
import com.supervision.framework.web.service.SysLoginService;
import com.supervision.framework.web.service.SysPermissionService;
...
public class SysLoginController {
    ...
    public AjaxResult login(@RequestBody LoginBody loginBody) {
        ...
        //code="0000";
        // 生成令牌
         String token = loginService.login(loginBody.getUsername(), loginBody.getPassword(), code,
                loginBody.getUuid());
