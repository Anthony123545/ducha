...
public class SupervisionConfig {
    ...
    public static void setProfileaddress(String profileaddress) {
        SupervisionConfig.profileaddress = profileaddress;
    }
    ...
    public void setProfile(String profile) {
        SupervisionConfig.profile = profile;
    }
    ...
    public void setAddressEnabled(boolean addressEnabled) {
        SupervisionConfig.addressEnabled = addressEnabled;
    }
