...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils
{
    ...
    public static String format(String str,String pattern){
        return DateFormatUtils.format(parseDate(str),pattern);
    }
     ...
     * @return
     */
    public static Date getStartgotothree(Date date){
    ...
    public static Date getTimeBeforeDay(String time,int day){
        ...
        c.set(Calendar.DAY_OF_MONTH,minute - day);
