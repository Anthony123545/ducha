...
/**
 * 教案库对象 thought_teacher_file
 * 
 * @author supervision
 * @date 2022-04-11
 */
public class ThoughtTeacherFile extends BaseEntity
{
    ...
    private List<ThoughtTeacherFile> thoughtTeacherFiles;


    public List<ThoughtTeacherFile> getThoughtTeacherFiles() {
        return thoughtTeacherFiles;
    }

    public void setThoughtTeacherFiles(List<ThoughtTeacherFile> thoughtTeacherFiles) {
        this.thoughtTeacherFiles = thoughtTeacherFiles;
    }
