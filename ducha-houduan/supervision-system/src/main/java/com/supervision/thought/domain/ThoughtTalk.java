...
/**
 * 谈心记录卡对象 thought_talk
 *
 * @author supervision
 * @date 2022-04-06
 */
public class ThoughtTalk extends BaseEntity
{
    ...
    public void setTalkObjectId(Long talkObjectId)
    {
        this.talkObjectId = talkObjectId;
    }

    public Long getTalkObjectId()
    {
        return talkObjectId;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("talkObject", getTalkObject())
            .append("talkObjectId", getTalkObjectId())
            ...
            .append("talkAddress", getTalkAddress())
