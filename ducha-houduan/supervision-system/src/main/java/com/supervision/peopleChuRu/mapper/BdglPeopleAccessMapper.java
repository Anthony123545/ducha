...
public interface BdglPeopleAccessMapper 
{
    ...
    Long countBdglPeopleAccessByDate(String date);

    BdglPeopleAccess selectBdglPeopleAccessByEmployeeNumber(String employeeNumber);

    int deleteBdglPeopleAccessByEmployeeNumbers(Long[] employeeNumbers);
}