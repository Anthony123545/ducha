...
/**
 * 单身干部宿舍对象 bdgl_single_cadre_dorm
 * 
 * @author ruoyi
 * @date 2022-08-08
 */
public class BdglSingleCadreDorm extends BaseEntity
{
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("usageArea", getUsageArea())
            .append("propertyFeeStandard", getPropertyFeeStandard())
            .append("rentStandard", getRentStandard())
            .append("waterBil", getWaterBil())
            .append("monthlyRent", getMonthlyRent())
            .append("monthlyPropertyFee", getMonthlyPropertyFee())
