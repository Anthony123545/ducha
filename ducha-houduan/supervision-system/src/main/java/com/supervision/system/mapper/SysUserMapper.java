...
public interface SysUserMapper {
    ...
    List<SysUser> selectUserLists(SysUser sysUser);
    /**根据用户id获取用户姓名*/
    List<SysUser> selectname(@Param("split") String[] split);
    ...
    @Select("SELECT user_id FROM sys_user WHERE user_name = #{name} LIMIT 1")
