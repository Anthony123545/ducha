define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'risk_report/index' + location.search,
                    add_url: 'risk_report/add',
                    edit_url: 'risk_report/edit',
                    del_url: 'risk_report/del',
                    multi_url: 'risk_report/multi',
                    import_url: 'risk_report/import',
                    table: 'risk_report',
                }
            });
