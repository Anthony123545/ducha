define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            // 初始化表格参数配置
            // $(".btn-add").data("area",["860px","90%"]);
			// $(".btn-edit").data("area",["860px","50%"]);
            Table.api.init({
                extend: {
                    index_url: 'daily_inspect/index' + location.search,
                    add_url: 'daily_inspect/add',
                    // edit_url: 'daily_inspect/edit',
                    del_url: 'daily_inspect/del',
                    multi_url: 'daily_inspect/multi',
                    import_url: 'daily_inspect/import',
                    table: 'daily_inspect',
                }
            });
