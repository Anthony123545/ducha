define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'soldier/index' + location.search,
                    add_url: 'soldier/add',
                    edit_url: 'soldier/edit',
                    del_url: 'soldier/del',
                    multi_url: 'soldier/multi',
                    import_url: 'soldier/import',
                    table: 'soldier',
                }
            });
        ...
        add: function () {
            Controller.api.bindevent();$("#c-people_id,#c-compere_id,#c-join_id,#c-people_ids,#c-absent_ids").data("params", function (obj) {
