define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            $(".btn-add").data("area",["1000px","700px"]);
            // 初始化表格参数配置
            Table.api.init({
                extend: {
                    index_url: 'plan_task/index' + location.search,
                    add_url: 'plan_task/add',
                    edit_url: 'plan_task/edit',
                    del_url: 'plan_task/del',
					entering_url:'plan_task/entering',
                    multi_url: 'plan_task/multi',
                    import_url: 'plan_task/import',
                    table: 'plan_task',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'unit_name', title: '发布单位', operate: 'LIKE'},
