define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'risk_live_question/index' + location.search,
                    // add_url: 'risk_live_question/add',
                    // edit_url: 'risk_live_question/edit',
                    // del_url: 'risk_live_question/del',
                    // multi_url: 'risk_live_question/multi',
                    // import_url: 'risk_live_question/import',
                    table: 'risk_live_question',
                }
            });
                    ...
                    [
                        ...
                        {field: 'operate', title: __('Operate'), table: table, events: Table.api.events.operate,buttons: [
							...
							},
							{
								...
								url:function(row){
									return 'risk_live_question/examine1?ids='+row['id'];
								},
								//extend: 'data-area=\'["1000px","80%"]\'',
								visible: function (row) {
									if (row['state'] == 2) {
        ...
        api: {
            ...
            formatter: {
                thumb: function (value, row, index) {
                    return '<a href="' + value + '" class="btn-dialog"><img src="' + value + '" alt="" style="max-height:90px;max-width:120px"></a>';
                },
