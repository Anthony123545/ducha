define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            $(".btn-add").data("area", ["740px", "360px"]);
            // 初始化表格参数配置
            Table.api.init({
                extend: {
                    index_url: 'consume_putin/index' + location.search,
                    add_url: 'consume_putin/add',
                    // edit_url: 'durg_putin/edit',
                    // del_url: 'durg_putin/del',
                    multi_url: 'consume_putin/multi',
                    import_url: 'consume_putin/import',
                    table: 'consume_putin',
                }
            });
            ...
            table.on('post-body.bs.table', function () {
                $(".btn-editone").data("area", ["750px", "360px"]);
            })
        },
        add: function () {
            Controller.api.bindevent();
            $("#c-durg_archives_id").data("eSelect", function(){
				$.get('consume_putout/huoq',{id:$("#c-durg_archives_id").val()},function(res){
