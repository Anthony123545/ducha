define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'visit/index' + location.search,
                    add_url: 'visit/add',
                    edit_url: 'visit/edit',
                    del_url: 'visit/del',
                    multi_url: 'visit/multi',
                    import_url: 'visit/import',
                    table: 'visit',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'arrive_time', title: __('Arrive_time'), operate:'RANGE', addclass:'datetimerange', autocomplete:false},
