define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            $(".btn-add").data("area", ["735px", "420px"]);
            // 初始化表格参数配置
            Table.api.init({
                extend: {
                    index_url: 'antiepidemic_archives/index' + location.search,
                    add_url: 'antiepidemic_archives/add',
                    edit_url: 'antiepidemic_archives/edit',
                    del_url: 'antiepidemic_archives/del',
                    multi_url: 'antiepidemic_archives/multi',
                    import_url: 'antiepidemic_archives/import',
                    table: 'antiepidemic_archives',
                }
            });
            ...
            table.on('post-body.bs.table', function () {
                $(".btn-editone").data("area", ["735px", "420px"]);
            })
        },
        add: function () {
