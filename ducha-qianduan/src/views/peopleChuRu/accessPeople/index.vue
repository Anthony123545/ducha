<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="审批人员id" align="center" prop="userId" min-width="100" />
      <el-table-column label="审批人员名称" align="center" prop="name" min-width="100" />
      <el-table-column label="审批人员职别" align="center" prop="level" min-width="100" />
      <el-table-column
        label="操作"
        align="center"
    ...
    >
      <div style="display: flex; flex-direction: column; gap: 12px; width:100px;">
        <el-form label-width="100px">
          <el-form-item label="人员名称">
            <el-select v-model="shenpiname" placeholder="请选择人员名称" style="width: 100%;">
              <el-option
          ...
          <el-form-item label="人员职别">
            <el-select v-model="shenpizhibie" placeholder="请选择人员职别" style="width: 200px;">
              <el-option
    ...
    >
      <div>
        <el-form label-width="100px">
          <el-form-item label="人员名称">
            <el-select v-model="form.name" placeholder="请选择人员名称" style="width: 100%;">
              <el-option
                v-for="item in userRen"
                :key="item.userId"
                :label="item.userName"
...
.jiben {
  width: 920px;
  height: 32px;
  background-image: url(~@/images/小标题.png);
  margin-bottom: 25px;
  color: #fff;
  padding-left: 16px;
  line-height: 32px;
