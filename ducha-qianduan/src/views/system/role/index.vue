<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8 button-row-fixed">
      <el-col :span="1.5">
        <el-button
          type="primary"
          plain
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button @click="cancelDataScope" size="btn">取 消</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
.button-row-fixed {
  ...
  overflow-x: auto; /* 如果空间不够可以横向滚动 */
}

.button-row-fixed .el-col {
  flex-shrink: 0 !important; /* 防止列被压缩 */
  margin-right: 8px; /* 添加一点间距 */
}
/* 对话框背景颜色 */
::v-deep .el-dialog {
