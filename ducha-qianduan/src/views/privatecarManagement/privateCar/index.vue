  ...
  <div class="app-container">
    ...
    >
      ...
      >
        ...
        <el-form-item label="在位情况" prop="state">
          <el-select
            v-model="form.state"
            placeholder="请选择车辆状态"
            clearable
          >
            <!-- 这里的 options 建议直接手动写死，或者从你的 this.private 字典里遍历 -->
            <el-option label="在位" value="1" class="input_xiala"></el-option>
            <el-option label="值班" value="2" class="input_xiala"></el-option>
            <el-option label="出车" value="3" class="input_xiala"></el-option>
            <el-option label="待修" value="4" class="input_xiala"></el-option>
          </el-select>
        </el-form-item>
  ...
  methods: {
    submitForm() {
      this.$refs["form"].validate((valid) => {
        ...
        if (this.form.id) {
          // 修改
          updatePrivateCar(this.form).then((res) => {
          ...
          // 新增
          addPrivateCar(this.form).then((res) => {
