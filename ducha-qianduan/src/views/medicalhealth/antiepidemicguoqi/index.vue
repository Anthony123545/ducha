<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="过期日期" align="center" prop="expirationTime" width="120">
        <template slot-scope="scope">
      ...
      <el-table-column label="备注" align="center" prop="place">
        <template slot-scope="scope">
          ...
          >手动添加</span>
          <span v-if="scope.row.expiredstatus == '0'" style="color: #13ce66">自动转入</span>
        </template>
      </el-table-column>
...
import {
  ...
  updateAntiepidemicputin2,
  delAntiepidemicputin,
  exportAntiepidemicputin,
  addAntiepidemicputins
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      this.$modal
        ...
        .then(() => {
          this.form.state = "1";
          updateAntiepidemicputin2(this.form).then(response => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.id != null) {
            ...
            addAntiepidemicputins(this.form).then(response => {
