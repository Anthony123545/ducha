<template>
  <div class="app-container">
    <el-form
      ...
      label-width="68px"
    >
      <!-- <el-form-item label="" prop="durgArchivesId">
        <el-input
      ...
      <el-form-item label="" prop="durgBrand">
        <el-input
      ...
      <!-- <el-form-item label="" prop="putinId">
        <el-input
    ...
    >
      ...
      >
        ...
        <!-- <el-form-item label="" prop="durgArchivesId">
          <el-input v-model="form.durgArchivesId" placeholder="请输入" />
        </el-form-item> -->
        <el-form-item label="销毁数量" prop="putIn">
        ...
        <el-form-item label="销毁时间" prop="putTime">
          <el-date-picker
            clearable
            size="small"
        ...
        <!-- <el-form-item label="" prop="putinId">
          <el-input v-model="form.putinId" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="" prop="status">
