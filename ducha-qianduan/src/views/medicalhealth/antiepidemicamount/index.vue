...
<script>
import {
  listAntiepidemicamount,
  getAntiepidemicamount,
  delAntiepidemicamount,
  addAntiepidemicamount,
  updateAntiepidemicamount,
  exportAntiepidemicamount,
} from "@/api/medicalhealth/antiepidemicamount";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm("是否确认删除防疫用品库存数据的数据项?", "警告", {
